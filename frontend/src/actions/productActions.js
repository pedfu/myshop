...
// => async() =>  this can be used because of thunk
...
export const createProduct = () => async(dispatch, getStore) => {
    try {
        dispatch({
...
export const updateProduct = (product) => async(dispatch, getStore) => {
    try {
        dispatch({
...
export const createReview = (productId, review) => async(dispatch, getStore) => {
    try {
        dispatch({
